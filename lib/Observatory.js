...
(function() {
  ...
  Observatory.GenericEmitter = (function(_super) {
      ...
      if ((formatter != null) && typeof formatter === 'function') {
        ...
        this.formatter = function(options) {
          ...
          return msg = {
            ...
            module: this.name ? this.name : options.module,
            object: options.obj,
    ...
    GenericEmitter.prototype._emitWithSeverity = function(options) {
      if ((options.severity == null) || options.severity > this.maxSeverity) {
        return;
      }
